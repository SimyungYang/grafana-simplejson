...
for (var i = timeserie.length - 1; i >= 0; i--) {
	...
	for (var y = series.datapoints.length-1; y >= 0; y--) {
		if (series.target == "2XX") {
			...
			series.datapoints[y][0] = Math.round(Math.random() * 6) + 7;
		} else if (series.target == "4XX") {
			series.datapoints[y][0] = Math.round(Math.random() * 2) + 0;
			...
			if ((diff > 30 && diff < 40) || (diff > 150 && diff < 170) || (diff > 350 && diff < 360) || (diff > 390 && diff < 410) || (diff > 650 && diff < 665) || (diff > 730 && diff < 745) || (diff > 860 && diff < 890)) {
				series.datapoints[y][0] = Math.round(Math.random() * 10) + 7
			} else {
				series.datapoints[y][0] = Math.round(Math.random() * 2) + 0;
			}
			...
			if ((diff > 30 && diff < 40) || (diff > 150 && diff < 170) ||  (diff > 390 && diff < 410) || (diff > 550 && diff < 565) || (diff > 730 && diff < 745) || (diff > 860 && diff < 865)) {
				...
				series.datapoints[y][0] = Math.round(Math.random() * 150) + 30;
			}
		}else if (series.target == "SCS"){
			var diff = series.datapoints.length - y;
			series.datapoints[y][0] = Math.round(Math.random() * 200) + 60;
		}else if (series.target == "MeTV"){
			series.datapoints[y][0] = Math.round(Math.random() * 70) + 10;
		}else if (series.target == "XPG_AI"){
			if (y < series.datapoints.length-2)
				var api_const = Math.round(((series.datapoints[y+1][0] + series.datapoints[y+2][0])/2));
			else
				var api_const = 15;
			series.datapoints[y][0] = Math.round(Math.random() * 3) * plus_minus + api_const;
			if(series.datapoints[y][0] > 33 || y/20%2==1)
				plus_minus = -1;
			if(series.datapoints[y][0] < 13 || y/20%2==0)
				plus_minus = 1;
		}else if (series.target == "SCS_AI"){
			if (y < series.datapoints.length-2)
				var api_const = Math.round(((series.datapoints[y+1][0] + series.datapoints[y+2][0])/2));
			else
				var api_const = 15;
			series.datapoints[y][0] = Math.round(Math.random() * 3) * plus_minus + api_const;
			if(series.datapoints[y][0] > 45 || y/20%2==1)
				plus_minus = -1;
			if(series.datapoints[y][0] < 11 || y/20%2==0)
				plus_minus = 1;
		}else if (series.target == "MeTV_AI"){
			if (y < series.datapoints.length-2)
				var api_const = Math.round(((series.datapoints[y+1][0] + series.datapoints[y+2][0])/2));
			else
				var api_const = 4;
			series.datapoints[y][0] = Math.round(Math.random() * 3) * plus_minus + api_const;
			if(series.datapoints[y][0] > 30 || y/20%2==1)
				plus_minus = -1;
			if(series.datapoints[y][0] < 4 || y/20%2==0)
				plus_minus = 1;
